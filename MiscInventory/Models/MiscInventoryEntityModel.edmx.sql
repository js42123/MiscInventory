...
-- --------------------------------------------------
-- Date Created: 10/24/2018 11:40:00
-- Generated from EDMX file: D:\workAHTD\JS42123\MiscInventory\MiscInventory\Models\MiscInventoryEntityModel.edmx
-- --------------------------------------------------
...
ALTER TABLE [dbo].[T115_MISC_TRAN_ARCHV]
ADD CONSTRAINT [FK_MiscInventoryTransArch]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_MiscInventoryTransArch'
CREATE INDEX [IX_FK_MiscInventoryTransArch]
...
ALTER TABLE [dbo].[T115_MISC_TRANS]
ADD CONSTRAINT [FK_MiscInventoryTrans]
    FOREIGN KEY ([T115_MISC_INVENTORYT115_MISC_INVENTORY_PRIMARY_KEY])
    REFERENCES [dbo].[T115_MISC_INVENTORY]
        ([T115_MISC_INVENTORY_PRIMARY_KEY])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_MiscInventoryTrans'
CREATE INDEX [IX_FK_MiscInventoryTrans]
